    ...
    def run(self):
        try:
            if self.request_type == "menu":
                ...
                url = f"https://gfwsl.geforce.com/nvidia_web_services/controller.php?com.nvidia.services.Drivers.getMenuArrays/{params_str}"  # noqa: E501
...
class NvidiaDriverLookupGUI(QMainWindow):
    ...
    def search_drivers(self):
        ...
        query_url = (
            f"https://gfwsl.geforce.com/services_toolkit/services/com/nvidia/services/AjaxDriverService.php?func=DriverManualLookup"  # noqa: E501
            f"&pfid={product_id}&psid={series_id}&osID={os_id}&languageCode={lang_id}&dch={"1" if str(os_id) in dch_1_oses else "0"}&dltype=-1&numberOfResults={NUMBER_OF_RESULTS}"  # noqa: E501
        )
